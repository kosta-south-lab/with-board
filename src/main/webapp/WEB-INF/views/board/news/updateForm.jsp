...
<head>
  ...
  <link href="${pageContext.request.contextPath}/css/board/news/newsregister.css" rel="stylesheet">
      ...
      <div class="container">
        <div class="row">
		  ...
		  <div class="col-lg-6" style="text-align: center; margin: 0 auto">
            <form action="${pageContext.request.contextPath}/board/news/update" method="post" enctype="multipart/form-data" name="registerForm" >
              ...
              <div class="form-group mt-3">
                내용 :<p>
				<textarea class="form-control" rows="15" name="content">${news.content}</textarea>
				<p>
              </div>
             <div class="form-group mt-3">
