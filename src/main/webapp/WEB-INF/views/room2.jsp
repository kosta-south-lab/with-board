...
<script type="text/javascript">
	...
	function createRoom(){
		$("#createRoom2").click(function(){
			var msg = {	roomName : $('#roomName').val()	};
			console.log($('#roomName').val());
		   document.getElementById("joinMatchTitle").value=$('#roomName').val();
		...
		if(res != null){
			...
			res.forEach(function(d, idx){
				...
				tag += "<tr>"+
							...
							"<td class='room'>"+ rn +"</td>"+
							"<td class='go'><button class=learn-more type='button' onclick='goRoom(\""+roomNumber+"\", \""+rn+"\")'>참여</button></td>" +
						"</tr>";	
			});
...
<form action="${pageContext.request.contextPath}/room/insert" method="post" name="registerForm">
	<div class="container">
		<h1>채팅방</h1>
		<div id="roomContainer" class="roomContainer" style="height:auto;">
			<table id="roomList" class="roomList" style="height:auto;"></table>
		</div>
		<div>
